from Atividades.menu import Menu
from Atividades.filtros_imagem import FiltrosImagem
from Atividades.face_mesh_background import FaceMeshBackground
from Atividades.jogos import Jogos
